...
// console.log(greetUser('HeadachyPie'))
...
function check(obj) {
    return obj.title.includes('15% Off!');
}

const filteredDeals = deals.filter(check)

console.log(filteredDeals.replace('15% Off!', '10% Off!'))
