...
let emp0ne = new Employee ('Brant', 'weekday mornings, weekend nights')
// console.log(emp0ne)
/*
...
let manager = new Manager ('Winston', 'weekday mornings, weekday afternoons', 'employees: Cece and Schmidt')
// console.log(manager)
/*
